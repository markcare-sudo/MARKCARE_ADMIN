...
// FIX: Ensure this file is named VerifyUser.jsx or VerifyUser/index.jsx
      ...
      <Routes location={location}>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<DashboardLayout />}>
            <Route path="/" element={<ErrorBoundary><PlatformDashboard /></ErrorBoundary>} />
            <Route path="/dashboard" element={<ErrorBoundary><PlatformDashboard /></ErrorBoundary>} />
            <Route path="/masters/roles" element={<ErrorBoundary><RolesPage /></ErrorBoundary>} />
            <Route path="/masters/users" element={<ErrorBoundary><UsersPage /></ErrorBoundary>} />
            <Route path="/masters/modules" element={<ErrorBoundary><ModulesPage /></ErrorBoundary>} />
            ...
            <Route path="/sales/orders" element={<ErrorBoundary><OrdersPage /></ErrorBoundary>} />
            <Route path="/sales/bookings" element={<ErrorBoundary><BookingsPage /></ErrorBoundary>} />
            <Route path="/blogs" element={<ErrorBoundary><BlogsPage /></ErrorBoundary>} />
            <Route path="/call-back-requests" element={<ErrorBoundary><CallBackRequestsPage /></ErrorBoundary>} />
