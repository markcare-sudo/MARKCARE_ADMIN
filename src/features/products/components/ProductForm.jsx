...
//     // ✅ Convert specifications (object → array)
//     const specsArray = Object.entries(initialData.common_specifications || {}).map(
//         ([key, value]) => ({ key, value })
//     );

//     // fallback if empty
//     const finalSpecs = specsArray.length ? specsArray : BASE_SPECS;

//     // ✅ MAIN IMAGE (Cloudinary or URL)
//     const mainImage = initialData.images?.find(img => img.is_primary);

//     // ✅ Variants mapping
//     const mappedVariants = initialData.variants?.map(v => {
//         const variantImage = v.variant_images?.[0]; // first image
...
//             preview: variantImage?.url || null // existing image
//         };
//     }) || [];
...
//         common_specifications: finalSpecs,
//         variants: mappedVariants.length ? mappedVariants : form.variants,
//         image: null,
//         preview: mainImage?.url || null
//     });
...
//     //         if (form.image) formData.append("main_image", form.image);

//     //         form.variants.forEach((v, i) => {
//     //             if (v.image) formData.append(`variant_${i}`, v.image);
//     //         });
...
//                 existing_variants: initialData?.variants || []
//             };
...
//             // ✅ VARIANT IMAGES (IMPORTANT NAMING)
//             form.variants.forEach((v, i) => {
//                 if (v.image) {
...
//                     <label className="border-2 border-dashed h-48 flex items-center justify-center rounded cursor-pointer overflow-hidden">
//                         {form.preview ? (
//                             <img src={form.preview} className="w-full h-full object-cover" />
//                         ) : (
//                             <FiUpload size={22} />
//                         )}
//                         <input hidden type="file" onChange={e => handleMainImage(e.target.files[0])} />
//                     </label>
//                 </div>
//             </div>
...
//                 {/* HEADER */}
//                 <div className="grid grid-cols-6 gap-4 text-xs font-semibold text-gray-500 mb-2 px-2">
//                     <div>Image</div>
//                     <div>Price</div>
//                     <div>Stock</div>
...
//                     <div
//                         key={i}
//                         className="grid grid-cols-6 gap-4 items-center border p-3 bg-gray-50"
//                     >
//                         {/* IMAGE */}
